  ...
  return (
    <Layout pageTitle={pageTitle}>
      ...
      <div className='prose prose-base max-w-none m-6 w-4/5'>
        ...
        <div className='flex'>
          <div>
            <h2 className='m-auto text-aolKhaki'>Den Leader: <span className='font-lg text-scoutDarkGray'>{markdownRemark.frontmatter.denleader}</span></h2>
          </div>
          <div>
            <h2 className='m-auto ml-6 text-aolKhaki'>Assistant Den Leader: <span className='font-lg text-scoutDarkGray'>{markdownRemark.frontmatter.assistantdenleader}</span></h2>
          </div>
        </div>
