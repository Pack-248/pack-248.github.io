...
const PrivacyPage = () => {
  return (
    <Layout pageTitle="Privacy">
      <div class="max-w-none flex flex-wrap -mx-4 -mt-4 -mb-10 sm:-m-4"><div class="p-4 mb-6 w-auto prose"><p>Last updated: June 17, 2024</p>
<p>This privacy policy ("policy") will help you understand how Cub Scout Pack 248 ("us", "we", "our") uses and protects the data you provide to us when you visit and use https://freedomaintfree.us ("website", "blog", "service").</p>
...
<p>Our blog contains links that lead to other websites. If you click on these links Cub Scout Pack 248 is not held responsible for your data and privacy protection. Visiting those websites is not governed by this privacy policy agreement. Make sure to read the privacy policy documentation of the website you go to from our website.</p>
...
<p>Cub Scout Pack 248 will not lease, sell or distribute your personal information to any third parties, unless we have your permission. We might do so if the law forces us. Your personal information will be used when we need to send you promotional materials if you agree to this privacy policy.</p></div></div>
    </Layout>
  )
}

export const Head = () => <title>Pack 248 - Privacy Policy</title>
