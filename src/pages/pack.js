  ...
  return (
    ...
    <div className='w-full h-full m-auto flex text-scoutWarmGray '>
      ...
      <div className='prose prose-base rounded-lg m-6 bg-cubScoutBlue'>
        ...
        <ul className='mb-6'>
        <li className='list-none text-scoutTan font-bold'><FontAwesomeIcon icon={['fas', 'envelope']}/><span className='ml-4 text-scoutLightTan font-extralight'><a href="mailto:pack248mi@gmail.com" target="_blank" rel="noreferrer" className='text-scoutLightTan no-underline font-extralight'>pack248mi@gmail.com</a></span></li>
        <li className='list-none text-scoutTan font-bold'><FontAwesomeIcon icon={['fab', 'facebook']}/><span className='ml-4 text-scoutLightTan font-extralight'><a href="https://www.facebook.com/groups/Eriepack248/" target="_blank" rel="noreferrer" className='text-scoutLightTan no-underline font-extralight'>EriePack248</a></span></li>
        <li className='list-none text-scoutTan font-bold'><FontAwesomeIcon icon={['fas', 'globe']}/><span className='ml-4 text-scoutLightTan font-extralight'><a href="https://pack248.org" target="_blank" rel="noreferrer"  className='text-scoutLightTan no-underline font-extralight'>Website</a></span></li>
        <li className='list-none text-scoutTan font-extralight flex'>
        ...
        </svg><a href="https://beascout.scouting.org/list/?zip=48038&program%5B%5D=pack&unitID=233029" target="_blank" rel="noreferrer"  className='text-scoutLightTan no-underline font-extralight'>Be A Scout</a></li>
        </ul>
      </div>
    </div>
    </Layout>
