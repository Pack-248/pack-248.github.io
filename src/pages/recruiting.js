    ...
    return (
        <Layout pageTitle="Recruiting">
             <div className='prose prose-base m-6 max-w-none'>
                <div id='background' className='bg-cover bg-center h-96 rounded-lg'  style={{backgroundImage: `url('../images/misc/recruiting-web-banner.jpg')`,}}>
                    <div className='h-full flex flex-col justify-center items-center'>
                    </div>
                </div>
                <div className='flex flex-row flex-wrap pt-6'>
                    <div id='recuritingText' className='w-1/2 px-4'>
                        ...
                        <ol>
                            ...
                            <li><span className='font-semibold'>Sign Up:</span> Fill out the registration form at <a href='https://beascout.scouting.org/list/?zip=48038&program%5B%5D=pack&unitID=233029' target='_blank' rel='noreferer'>BeAScout.org</a> or contact one of our Pack leaders to get started.</li>
                        </ol>
                    ...
                    <div id='recruitingimage' className='w-1/2 px-4'>
                        <img src='/images/logo/Pack 248 Logo.webp' alt='Pack 248 Logo'/>
                        <img src='/images/misc/recruiting-2.png' alt='Boys and Girls K-5'/>
                    </div>
                </div>
            </div>
        </Layout>
