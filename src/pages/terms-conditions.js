...
const TermsPage = () => {
  return (
    ...
    <div class="max-w-none flex flex-wrap -mx-4 -mt-4 -mb-10 sm:-m-4"><div class="p-4 mb-6 w-auto prose"><p>updated: July 3, 2024</p>
<h2>AGREEMENT TO OUR LEGAL TERMS</h2>
<p>We are Cub Scout Pack 248 ("<strong>Company</strong>," "<strong>we</strong>," "<strong>us</strong>," "<strong>our</strong>").</p>
<p>We operate this website, as well as any other related products and services that refer or link to these legal terms (the "<strong>Legal Terms</strong>") (collectively, the "<strong>Services</strong>").</p>
<p>You can contact us by email at <a href="mailto:info@freedomaintfree.us">info@freedomaintfree.us</a>.</p>
<p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("<strong>you</strong>"), and Skratsch Solutions,LLC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
...
<li><a href="#you-are-responsible-for-what-you-post-or-upload">You are responsible for what you post or upload</a></li>
</ul>
</li>
...
<ul>
<li><a href="#informal-negotiations">Informal Negotiations</a></li>
<li><a href="#binding-arbitration">Binding Arbitration</a></li>
<li><a href="#restrictions">Restrictions</a></li>
<li><a href="#exceptions-to-informal-negotiations-and-arbitration">Exceptions to Informal Negotiations and Arbitration</a></li>
</ul>
</li>
...
<p>Subject to your compliance with these Legal Terms, including the "<a href="#prohibited-activities">PROHIBITED ACTIVITIES</a>" section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
<ul>
...
<p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:info@freedomaintfree.us">info@freedomaintfree.us</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
<p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
<p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to use our Services will terminate immediately.</p>
<h3>Your submissions</h3>
<p>Please review this section and the "<a href="#prohibited-activities">PROHIBITED ACTIVITIES</a>" section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</p>
<h3>Submissions</h3>
...
<ul>
<li>confirm that you have read and agree with our "<a href="#prohibited-activities">PROHIBITED ACTIVITIES</a>" and will not post, send, publish, upload, or transmit through the Services any Submission that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading;</li>
...
<h2>GOVERNING LAW</h2>
<p>These Legal Terms shall be governed by and defined following the laws of the State of Michigan. Cub Scout Pack 248 and yourself irrevocably consent that the courts of Wayne County shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
<h2>DISPUTE RESOLUTION</h2>
<h3>Informal Negotiations</h3>
<p>To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each a "Dispute" and collectively, the "Disputes") brought by either you or us (individually, a "Party" and collectively, the "Parties"), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least 30 days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.</p>
<h3>Binding Arbitration</h3>
<p>Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be 1. The seat, or legal place, or arbitration shall be Wayne County, Michigan. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of the State of Michigan.</p>
<h3>Restrictions</h3>
...
<p><strong>email</strong>: <a href="mailto:pack248mi@gmail.com">pack248@gmail.com</a> or</p>
<p><strong>phone</strong>: <a href="tel:15864190427">+1 586 419 0427</a></p></div></div>
</Layout>
  )
}

export const Head = () => <title>Pack 248 - Terms &amp; Conditions</title>
