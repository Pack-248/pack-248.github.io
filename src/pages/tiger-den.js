  ...
  return (
    ...
    <div className='flex w-full h-full m-auto text-scoutWarmGray '>
      <div className='w-4/5 m-6 prose prose-base max-w-none'>
        ...
        <div className='flex'>
          <div>
            <h2 className='m-auto text-tigerOrange'>Den Leader: <span className='font-lg text-scoutDarkGray'><EmailLink className='no-underline text-scoutDarkGray' personName={markdownRemark.frontmatter.denleader} personEmail={markdownRemark.frontmatter.denleaderemail}/></span></h2>
          </div>
          <div>
            <h2 className='m-auto ml-6 text-tigerOrange'>Assistant Den Leader: <span className='font-lg text-scoutDarkGray'><EmailLink className='no-underline text-scoutDarkGray' personName={markdownRemark.frontmatter.assistantdenleader} personEmail={markdownRemark.frontmatter.assistantdenleaderemail}/></span></h2>
          </div>
        </div>
      ...
      <div className='hidden md:rounded-lg md:text-center md:m-6 md:block md:prose md:prose-base md:bg-tigerOrange'>
